...
const Services = [
  {
    ...
    path: "/service/data-engineering-analytics/accelerated-generative-ai",
    col: "col-lg-4 col-md-6",
    sImg: "/img/services/dataengineer/d10.jpg",
  },
  {
    title: "Data Engineering",
    path: "/service/data-engineering-analytics/data-engineering",
    col: "col-lg-4 col-md-6",
    sImg: "/img/services/dataengineer/d4.jpg",
  },
  {
    title: "Responsible AI for Gen AI",
    path: "/service/data-engineering-analytics/responsible-ai-for-gen-ai",
    col: "col-lg-4 col-md-6",
    sImg: "/img/services/dataengineer/d11.jpg",
  },
  {
    title: "Visualization and Analytics",
    path: "/service/data-engineering-analytics/visualization-and-analytics",
    col: "col-lg-4 col-md-6",
    sImg: "/img/services/dataengineer/d2.jpg",
  },
];

const Service = {
  title: "Data Engineering & Analytics",
  description: `We design robust data pipelines and analytics systems that transform raw data into actionable insights.
Our solutions empower businesses to make informed decisions with speed, accuracy, and scalability.`,
  images: ["/img/services/dataengineer/d4.jpg"],
};
const DataEngineerAnalyticsPage = () => {
  const ClickHandler = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Data Engineering & Analytics | BRVTeck</title>
        <meta
          name="description"
          content="Discover how BRVTeck delivers advanced Data Engineering and Analytics solutions using AI to power insights and business transformation."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="keywords"
          content="Data Engineering, Analytics, AI, BRVTeck, Visualization, Generative AI, Responsible AI"
        />
        <meta name="author" content="BRVTeck" />
        <meta
          property="og:title"
          content="Data Engineering & Analytics | BRVTeck"
        />
        <meta
          property="og:description"
          content="We empower your business with intelligent data pipelines, analytics platforms, and AI-driven insights for smarter decisions."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://brvteck.com/service/data-engineering-analytics"
        />
        <meta
          property="og:image"
          content="https://brvteck.com/img/services/dataengineer/d4.jpg"
        />
      </Head>
      <Header />
      <main className="page_content service-single-page">
        ...
        <section className="service_details_section section_space bg-light">
          <div className="container">
            ...
            <p>
              Our expert team uses industry-leading practices and technologies
              to ensure our clients receive the best-in-class solutions for
              their needs.
            </p>
...
export default DataEngineerAnalyticsPage;
